...
# Instructions for each piece to be completed for this project can be found in
#the file, below.
...
#https://www.programsinformationpeople.org/runestone/static
#/publicpy3/Classes/ThinkingAboutClasses.html,
...
#Search API: songs, movies, ebooks and audiobooks... (and more)
#You'll definitely need to check out the documentation to understand/recall how
...
# and how you could invoke it to get data from iTunes Search
# about e.g. just songs corresponding to a certain search term, just movies,
# or just books.
...
# The Media class should accept one dictionary data structure representing
# a piece of media from iTunes as input to the constructor.
# Its constructor should invoke a method to get and cache data,
# and instatiate at least the following instance variables:
# - title
# - author
# - itunes_URL
# - itunes_id (e.g. the value of the track ID, whatever the track is in
...
# input, as all contains methods must, which should always be a string,
# and checks to see if the string input to this contains method is
# INSIDE the string representing the title of this piece of media
